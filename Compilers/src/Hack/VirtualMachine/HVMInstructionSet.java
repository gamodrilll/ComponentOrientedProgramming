...
public class HVMInstructionSet {
    ...
    private void initSegmentStrings() {
        ...
        segmentPointerStrings.put(LOCAL_SEGMENT_VM_STRING, Utilities.Definitions.LOCAL_POINTER_NAME);
        segmentPointerStrings.put(ARG_SEGMENT_VM_STRING, Utilities.Definitions.ARG_POINTER_NAME);
        segmentPointerStrings.put(THIS_SEGMENT_VM_STRING, Utilities.Definitions.THIS_POINTER_NAME);
        segmentPointerStrings.put(THAT_SEGMENT_VM_STRING, Utilities.Definitions.THAT_POINTER_NAME);
