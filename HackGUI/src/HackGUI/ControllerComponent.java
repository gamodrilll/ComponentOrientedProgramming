 ...
 */
public class ControllerComponent extends JFrame implements Controller.ControllerGUI,
                                                           FilesTypeListener,
    ...
    public void setSimulator(Controller.HackSimulatorGUI simulator) {
    ...
    protected void init() {
        speedSlider = new JSlider(JSlider.HORIZONTAL, 1, Controller.HackController.NUMBER_OF_SPEED_UNITS, 1);
     ...
     */
    public void addControllerListener(Controller.ControllerEventListener listener) {
     ...
     */
    public void removeControllerListener(Controller.ControllerEventListener listener){
    ...
    public void notifyControllerListeners(byte action, Object data) {
        Controller.ControllerEvent event = new Controller.ControllerEvent(this,action,data);
        for(int i=0;i<listeners.size();i++)
            ((Controller.ControllerEventListener)listeners.elementAt(i)).actionPerformed(event);
    }
    ...
    public void filesNamesChanged(FilesTypeEvent event) {
        if(event.getFirstFile() != null) {
            ...
            notifyControllerListeners(Controller.ControllerEvent.SCRIPT_CHANGE,event.getFirstFile());
        }
    ...
    public void breakpointsChanged(BreakpointsChangedEvent event) {
        notifyControllerListeners(Controller.ControllerEvent.BREAKPOINTS_CHANGE, event.getBreakpoints());
    }
    ...
    private void scriptPressed() {
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION) {
            notifyControllerListeners(Controller.ControllerEvent.SCRIPT_CHANGE, fileChooser.getSelectedFile().getAbsoluteFile());
    ...
    public void additionalDisplayCombo_actionPerformed (ActionEvent e) {
        ...
        switch (selectedIndex) {
            case Controller.HackController.SCRIPT_ADDITIONAL_DISPLAY:
                if (!scriptMenuItem.isSelected())
                    scriptMenuItem.setSelected(true);
                break;

            case Controller.HackController.OUTPUT_ADDITIONAL_DISPLAY:
                if (!outputMenuItem.isSelected())
                    outputMenuItem.setSelected(true);
                break;

            case Controller.HackController.COMPARISON_ADDITIONAL_DISPLAY:
                if (!compareMenuItem.isSelected())
                    compareMenuItem.setSelected(true);
                break;

            case Controller.HackController.NO_ADDITIONAL_DISPLAY:
                if (!noAdditionalDisplayMenuItem.isSelected())
                    noAdditionalDisplayMenuItem.setSelected(true);
                break;
        }

        notifyControllerListeners(Controller.ControllerEvent.ADDITIONAL_DISPLAY_CHANGE, new Integer(selectedIndex));
    }
    ...
    public void loadProgramButton_actionPerformed(ActionEvent e) {
        notifyControllerListeners(Controller.ControllerEvent.LOAD_PROGRAM,null);
    }
    ...
    public void ffwdButton_actionPerformed(ActionEvent e) {
        notifyControllerListeners(Controller.ControllerEvent.FAST_FORWARD,null);
    }
    ...
    public void rewindButton_actionPerformed(ActionEvent e) {
        notifyControllerListeners(Controller.ControllerEvent.REWIND, null);
    }
    ...
    public void singleStepButton_actionPerformed(ActionEvent e) {
        notifyControllerListeners(Controller.ControllerEvent.SINGLE_STEP, null);
    }
    ...
    public void stopButton_actionPerformed(ActionEvent e) {
        notifyControllerListeners(Controller.ControllerEvent.STOP, null);
    }
    ...
    public void SpeedSlider_stateChanged(ChangeEvent e) {
        ...
        if (!source.getValueIsAdjusting()) {
            ...
            notifyControllerListeners(Controller.ControllerEvent.SPEED_CHANGE, new Integer(speed));
        }
    }
    ...
    public void animationCombo_actionPerformed(ActionEvent e) {
        ...
        switch (selectedIndex) {
            case Controller.HackController.DISPLAY_CHANGES:
                if (!partAnimMenuItem.isSelected())
                    partAnimMenuItem.setSelected(true);
                break;

            case Controller.HackController.ANIMATION:
                if (!fullAnimMenuItem.isSelected())
                    fullAnimMenuItem.setSelected(true);
                break;

            case Controller.HackController.NO_DISPLAY_CHANGES:
                if (!noAnimMenuItem.isSelected())
                    noAnimMenuItem.setSelected(true);
                break;
        }

        notifyControllerListeners(Controller.ControllerEvent.ANIMATION_MODE_CHANGE,new Integer(selectedIndex));
    }
    ...
    public void formatCombo_actionPerformed(ActionEvent e) {
        ...
        switch (selectedIndex) {
            case Controller.HackController.DECIMAL_FORMAT:
                if (!decMenuItem.isSelected())
                    decMenuItem.setSelected(true);
                break;

            case Controller.HackController.HEXA_FORMAT:
                if (!hexaMenuItem.isSelected())
                    hexaMenuItem.setSelected(true);
                break;

            case Controller.HackController.BINARY_FORMAT:
                if (!binMenuItem.isSelected())
                    binMenuItem.setSelected(true);
                break;
        }

        notifyControllerListeners(Controller.ControllerEvent.NUMERIC_FORMAT_CHANGE,new Integer(selectedIndex));
    }
    ...
    public void partAnimMenuItem_actionPerformed(ActionEvent e) {
        if (!animationCombo.isSelectedIndex(Controller.HackController.DISPLAY_CHANGES))
            animationCombo.setSelectedIndex(Controller.HackController.DISPLAY_CHANGES);
    }
    ...
    public void fullAnimMenuItem_actionPerformed(ActionEvent e) {
        if (!animationCombo.isSelectedIndex(Controller.HackController.ANIMATION))
            animationCombo.setSelectedIndex(Controller.HackController.ANIMATION);
    }
    ...
    public void noAnimMenuItem_actionPerformed(ActionEvent e) {
        if (!animationCombo.isSelectedIndex(Controller.HackController.NO_DISPLAY_CHANGES))
            animationCombo.setSelectedIndex(Controller.HackController.NO_DISPLAY_CHANGES);
    }
    ...
    public void decMenuItem_actionPerformed(ActionEvent e) {
        if (!formatCombo.isSelectedIndex(Controller.HackController.DECIMAL_FORMAT))
            formatCombo.setSelectedIndex(Controller.HackController.DECIMAL_FORMAT);
    }
    ...
    public void hexaMenuItem_actionPerformed(ActionEvent e) {
        if (!formatCombo.isSelectedIndex(Controller.HackController.HEXA_FORMAT))
            formatCombo.setSelectedIndex(Controller.HackController.HEXA_FORMAT);
    }
    ...
    public void binMenuItem_actionPerformed(ActionEvent e) {
        if (!formatCombo.isSelectedIndex(Controller.HackController.BINARY_FORMAT))
            formatCombo.setSelectedIndex(Controller.HackController.BINARY_FORMAT);
    }
    ...
    public void scriptDisplayMenuItem_actionPerformed (ActionEvent e) {
        if (!additionalDisplayCombo.isSelectedIndex(Controller.HackController.SCRIPT_ADDITIONAL_DISPLAY))
            additionalDisplayCombo.setSelectedIndex(Controller.HackController.SCRIPT_ADDITIONAL_DISPLAY);
    }
    ...
    public void outputMenuItem_actionPerformed (ActionEvent e) {
        if (!additionalDisplayCombo.isSelectedIndex(Controller.HackController.OUTPUT_ADDITIONAL_DISPLAY))
            additionalDisplayCombo.setSelectedIndex(Controller.HackController.OUTPUT_ADDITIONAL_DISPLAY);
    }
    ...
    public void compareMenuItem_actionPerformed (ActionEvent e) {
        if (!additionalDisplayCombo.isSelectedIndex(Controller.HackController.COMPARISON_ADDITIONAL_DISPLAY))
            additionalDisplayCombo.setSelectedIndex(Controller.HackController.COMPARISON_ADDITIONAL_DISPLAY);
    }
    ...
    public void noAdditionalDisplayMenuItem_actionPerformed (ActionEvent e) {
        if (!additionalDisplayCombo.isSelectedIndex(Controller.HackController.NO_ADDITIONAL_DISPLAY))
            additionalDisplayCombo.setSelectedIndex(Controller.HackController.NO_ADDITIONAL_DISPLAY);
    }
