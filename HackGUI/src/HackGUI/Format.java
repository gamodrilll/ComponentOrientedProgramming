...
public class Format {
     ...
     * The decimal format.
     */
    public static final int DEC_FORMAT = Controller.HackController.DECIMAL_FORMAT;

    /**
     * The hexadecimal format.
     */
    public static final int HEX_FORMAT = Controller.HackController.HEXA_FORMAT;

    /**
     * The binary format.
     */
    public static final int BIN_FORMAT = Controller.HackController.BINARY_FORMAT;
