 ...
 */
public class TextFileComponent extends JPanel implements ComputerParts.TextFileGUI {
    ...
    public void addTextFileListener(ComputerParts.TextFileEventListener listener) {
        listeners.addElement(listener);
    }


    public void removeTextFileListener(ComputerParts.TextFileEventListener listener) {
        listeners.removeElement(listener);
    }

    public void notifyTextFileListeners(String row, int rowNum) {
        ComputerParts.TextFileEvent event = new ComputerParts.TextFileEvent(this,row,rowNum);
        for (int i=0;i<listeners.size();i++) {
           ((ComputerParts.TextFileEventListener)listeners.elementAt(i)).rowSelected(event);
        }
    }
