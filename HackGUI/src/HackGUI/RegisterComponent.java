 ...
 */
public class RegisterComponent extends JPanel implements ComputerParts.RegisterGUI {
    ...
    public void notifyListeners(int address, short value) {
        ComputerParts.ComputerPartEvent event = new ComputerParts.ComputerPartEvent(this,0,value);
