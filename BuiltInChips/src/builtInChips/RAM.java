...
/**
 * builtInChips.RAM chip of a variable size, each memory location is 16 bit-wide.
 ...
 * to change them.
 * Used as a base class for all builtInChips.RAM chips.
 */
public abstract class RAM extends BuiltInGateWithGUI implements ComputerParts.ComputerPartEventListener {
    ...
    /**
     * Constructs a new builtInChips.RAM of the given size.
     */
    public RAM(int size) {
