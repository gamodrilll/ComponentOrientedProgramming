...
public class ROM32K extends BuiltInGateWithGUI
 implements ComputerParts.ComputerPartEventListener, Events.ProgramEventListener {
     ...
     */
    public ROM32K() {
        values = new short[Utilities.Definitions.ROM_SIZE];
    ...
    protected void loadProgram(String fileName) throws AssemblerException {
        short[] program = HackAssemblerTranslator.loadProgram(fileName,
                                                              Utilities.Definitions.ROM_SIZE,
                                                              (short)0);
