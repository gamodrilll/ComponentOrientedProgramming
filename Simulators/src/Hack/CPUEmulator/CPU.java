...
public class CPU
{
    ...
    // The data register
    protected ComputerParts.Register D;
    ...
    // The bus.
    protected ComputerParts.Bus bus;
     ...
     */
    public CPU(RAM ram, ROM rom, PointerAddressRegisterAdapter A, ComputerParts.Register D,
               PointerAddressRegisterAdapter PC, ALU alu, ComputerParts.Bus bus) {
        this.M = ram;
        this.rom = rom;
        this.A = A;
        this.D = D;
     ...
     */
    public ComputerParts.Register getA() {
        return A;
    }
     ...
     */
    public ComputerParts.Register getD() {
        return D;
    }
     ...
     */
    public ComputerParts.Register getPC() {
        return PC;
    }
    ...
    public void executeInstruction() throws Controller.ProgramException {
        ...
        if ((instruction & 0x8000) == 0)
            ...
            throw new Controller.ProgramException("At line " + PC.get() +
									   ": Illegal instruction");

        if (!pcChanged) {
            short newPC = (short)(PC.get() + 1);
            if (newPC < 0 || newPC >= Utilities.Definitions.ROM_SIZE)
                throw new Controller.ProgramException("At line " + PC.get() +
	...
	// an illegal address.
    protected void computeExp(short instruction) throws Controller.ProgramException {
	...
	// an illegal address.
    protected void setDestination(short instruction) throws Controller.ProgramException {
    ...
    protected boolean checkJump(short instruction) throws Controller.ProgramException {
