 ...
 */
public interface CPUEmulatorGUI extends Controller.HackSimulatorGUI {
     ...
     */
    public ComputerParts.PointedMemoryGUI getRAM();
     ...
     */
    public ComputerParts.RegisterGUI getA();

    /**
     * Returns the D register GUI component.
     */
    public ComputerParts.RegisterGUI getD();

    /**
     * Returns the PC register GUI component.
     */
    public ComputerParts.RegisterGUI getPC();
