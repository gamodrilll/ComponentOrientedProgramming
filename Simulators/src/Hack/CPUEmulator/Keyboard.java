 ...
 * A computer keyboard.
 */
public class Keyboard extends ComputerParts.ComputerPart implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        short key = Utilities.Definitions.getInstance().getKeyCode(e);
        if (key > 0) {
            ram.setValueAt(Utilities.Definitions.KEYBOARD_ADDRESS, key, true);
            if (hasGUI)
                gui.setKey(Utilities.Definitions.getInstance().getKeyName(e));
        }
    }
    ...
    public void keyReleased(KeyEvent e) {
        ram.setValueAt(Utilities.Definitions.KEYBOARD_ADDRESS, (short)0, true);
        gui.clearKey();
    }
