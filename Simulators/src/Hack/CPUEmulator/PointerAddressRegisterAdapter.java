 ...
 * changes accordingly.
 */
public class PointerAddressRegisterAdapter extends ComputerParts.Register {

    // The pointed memory.
    protected ComputerParts.PointedMemory memory;
     ...
     */
    public PointerAddressRegisterAdapter(ComputerParts.RegisterGUI gui, ComputerParts.PointedMemory memory) {
