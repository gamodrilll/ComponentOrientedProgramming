 ...
 */
public interface VMEmulatorGUI extends Controller.HackSimulatorGUI {

    /**
     * Returns the bus GUI component.
     */
    public ComputerParts.BusGUI getBus();
     ...
     */
    public ComputerParts.LabeledPointedMemoryGUI getRAM();
     ...
     */
    public ComputerParts.PointedMemorySegmentGUI getWorkingStack();

    /**
     * Returns the Stack GUI component.
     */
    public ComputerParts.PointedMemorySegmentGUI getStack();

    /**
     * Returns the static memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getStaticSegment();

    /**
     * Returns the local memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getLocalSegment();

    /**
     * Returns the arg memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getArgSegment();

    /**
     * Returns the this memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getThisSegment();

    /**
     * Returns the that memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getThatSegment();

    /**
     * Returns the temp memory segment component.
     */
    public ComputerParts.MemorySegmentGUI getTempSegment();
